...
###########First Experiment Elastic Net #############
   ...
   # print("Creation timestamp: {}".format(exp.creation_time))
    ...
    #log model
    mlflow.sklearn.log_model(lr, "multi_exp_model_11")
...
########### Second run ######################
    ...
    mlflow.log_metrics(metrics)
    # log model
    mlflow.sklearn.log_model(lr, "multi_exp_model_12")
    mlflow.log_artifacts("./artifacts/")
    ...
    mlflow.log_metrics(metrics)
    # log model
    mlflow.sklearn.log_model(lr, "multi_exp_model_13")
    mlflow.log_artifacts("./artifacts/")
    ...
    mlflow.log_metrics(metrics)
    # log model
    mlflow.sklearn.log_model(lr, "multi_exp_model_21")
    mlflow.log_artifacts("./artifacts/")
    ...
    mlflow.log_metrics(metrics)
    # log model
    mlflow.sklearn.log_model(lr, "multi_exp_model_22")
    mlflow.log_artifacts("./artifacts/")
    ...
    mlflow.log_metrics(metrics)
    # log model
    mlflow.sklearn.log_model(lr, "multi_exp_model_23")
    mlflow.log_artifacts("./artifacts/")
    ...
    mlflow.log_metrics(metrics)
    # log model
    mlflow.sklearn.log_model(lr, "multi_exp_model_31")
    mlflow.log_artifacts("./artifacts/")
    ...
    mlflow.log_metrics(metrics)
    # log model
    mlflow.sklearn.log_model(lr, "multi_exp_model_32")
    mlflow.log_artifacts("./artifacts/")
    ...
    mlflow.log_metrics(metrics)
    # log model
    mlflow.sklearn.log_model(lr, "multi_exp_model_33")
    mlflow.log_artifacts("./artifacts/")
