...
if __name__ == "__main__":
    ...
    exp = mlflow.set_experiment(experiment_name="multi_project_experiment")
   ...
   # print("Creation timestamp: {}".format(exp.creation_time))
    ...
    #log model
    mlflow.sklearn.log_model(lr, "multi_run_model_1")
...
########### Second run ######################
    ...
    mlflow.log_metrics(metrics)
    # log model
    mlflow.sklearn.log_model(lr, "multi_run_model_2")
    mlflow.log_artifacts("artifacts/")
    ...
    mlflow.log_metrics(metrics)
    # log model
    mlflow.sklearn.log_model(lr, "multi_run_model_3")
    mlflow.log_artifacts("artifacts/")
